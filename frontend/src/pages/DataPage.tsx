...
const styles = {
  ...
  textarea: { width: '100%', padding: '10px 12px', border: '1px solid var(--border2)', borderRadius: 'var(--radius)', fontSize: 13, resize: 'vertical' as const, outline: 'none', color: 'var(--text)', lineHeight: 1.6 },
