...
const styles = {
  ...
  input: { padding: '8px 12px', border: '1px solid var(--border2)', borderRadius: 'var(--radius)', fontSize: 13.5, outline: 'none', color: 'var(--text)', background: 'var(--bg)' },
  ...
  textarea: { width: '100%', padding: '10px 12px', border: '1px solid var(--border2)', borderRadius: 'var(--radius)', fontSize: 13, resize: 'vertical' as const, outline: 'none', color: 'var(--text)', background: 'var(--bg3)', lineHeight: 1.6 },
  ...
  cellInput: { width: '100%', padding: '4px 8px', border: '1px solid var(--accent)', borderRadius: 4, fontSize: 13, outline: 'none', background: 'var(--bg)', color: 'var(--text)' },
